...
model TwoSpringJoystickControl "Two spring-damper system controlled by a joystick, input via ROS"
  ...
  Blocks.ROS_Sampler controller(samplePeriod = 0.05, nin = 2, nout = 2) "Provides control input to achieve desired spring state (position)" annotation(Placement(visible = true, transformation(origin = {30, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
